...
$getdata=mysqli_query($conn,"SELECT * FROM togolist WHERE id='$id'");
...
<body>
	...
	<form method="post" action="updatevalue.php" class="input_form">
        ...
        <tr><td>action:</td><td><input type="text" name="action" placeholder="Enter the action" value="<?php echo $action  ?>"></td></tr>
